# `@e2ee-lib/realtime` Package Guide

This page documents the public `@e2ee-lib/realtime` API that consumers use to
...
rectangle "@e2ee-lib/realtime" as Package {
...
`@e2ee-lib/realtime` is responsible for:
...
```ts
import { buildNoteEventsUrl } from '@e2ee-lib/realtime';
